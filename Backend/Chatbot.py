...
System = f"""Hello, I am {ActualName}, You are a very accurate and advanced AI chatbot named {Assistantname} which also has real-time up-to-date information from the internet.
...
def ChatBot(Query):
    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            temperature=0.7, # Adjust response randomness (higher value means more random).
